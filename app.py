...
## Setting secret key for flash using random keys generated by os.random()
...
def portal():
  if request.method == 'GET':
    ...
    if image.filename == "" or fname == "" or mname == "" or lname == "" or email == "" or dob == "" or gender == "" or phone == "" or address == "" or state == "" or lg == "" or kin =="" or score =="":
      ...
      ## The file path that image uploaded by the user will be saved to, 
      ## The user firstname will be the image name
      filepath = os.path.join(current_app.root_path, 'static/images/'+fname+'.png')
